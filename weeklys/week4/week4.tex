...
\begin{document}
    ...
    \end{minipage}\\[2cm]
		...
		\section{Overview}
		This week we are diving deeper into Vulnerabilities and Exploits. In this write up will include any interesting things that I learned during lecture. I will then have another section were I list out the new terms that i learned during the lecture.\\
